    ...
    <div className="h-[80vh] bg-sky-100 flex flex-col justify-center items-center py-2">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="text-center text-sm text-gray-600 flex gap-1 justify-center">
          Or
          <Link to="/signup" className="font-medium text-sky-400 hover:text-sky-600">
          ...
          <div>
            ...
            <div className="mt-1 relative flex items-center">
              ...
              <input
                ...
                className="block w-full pl-8 pr-3 py-1 text-[1rem] h-10 border-2 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-sky-500 focus:ring-2 focus:border-none sm:text-sm"
              />
            </div>
          </div>
