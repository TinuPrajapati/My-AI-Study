...
const THEMES = [
  "light", "dark", "bumblebee", "emerald", "synthwave",
  "cyberpunk", "valentine", "halloween", "aqua", "fantasy",
  "dracula", "cmyk", "acid", "lemonade", "night", "winter", "dim", "sunset"
];
    ...
    <nav className="bg-secondary text-white shadow-md flex justify-between items-center h-[8vh] sm:h-[10vh] px-5 py-1 overflow-x-hidden">
      ...
      <div className="flex items-center gap-2 h-full text-lg">
        <button
          ...
          className="hidden lg:block hover:bg-primary/80 font-semibold transition-colors px-4 py-1 rounded-md active:scale-90"
        >
          Theme
        </button>
        ...
        {authUser ? (
          ...
          <>
            <Link
              to="/Login"
              className="hidden lg:block bg-white text-primary px-4 py-1 font-semibold rounded-md transition-colors active:scale-90"
            >
              Login/Signup
            </Link>
          </>
        ...
        {authUser ?
          ...
          <Link
            to="/Login"
            className="bg-white lg:hidden text-primary text-[0.9rem] px-4 py-1 font-semibold rounded-md transition-colors"
          >
            Login/Signup
          </Link>
        }
        ...
        {/* Mobile Menu */}
        {mobileMenu && (
          <div className="lg:hidden absolute top-[10vh] left-0 w-full bg-secondary/80 p-4 space-y-2">
            <button
              onClick={() => setShow(!show)}
